...
const StoreReviewSection = ({ storeId, onReviewAdded }) => {
    ...
    const loadReviews = async () => {
        try {
            const response = await authApi().get(endpoints['store_detail'](storeId) + 'reviews/');
    ...
    const handleAddReview = async () => {
        ...
        try {
            ...
            const response = await authApi(token).post(endpoints['store_detail'](storeId) + 'reviews/', reviewData);
